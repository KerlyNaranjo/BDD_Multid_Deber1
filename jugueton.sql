...
id_empr int identity primary key,
ruc_empr numeric (10) not null,
nombre_suc varchar (20)not null,
direccion_suc varchar (20) not null,
tlf_suc numeric (10)not null,
id_provFK int FOREIGN KEY REFERENCES PROVEEDOR(id_prov ),
id_sucFK int FOREIGN KEY REFERENCES SUCURSAL(id_suc),
id_emplFK int FOREIGN KEY REFERENCES EMPLEADO(id_empl),
id_ventaFK int FOREIGN KEY REFERENCES VENTAS(id_venta)
)
